# Help center for AA Concierge V1
...
Connect the external provider with test credentials and verify failures show a merchant-readable error. If this does not work, check /status and deployment logs before contacting support.
